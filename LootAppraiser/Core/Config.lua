...
local generalOptionsGroup =  {
    ...
    args = {
        ...
        goldAlertThreshold = {
            type = "input", order = 30, name = "Gold Alert Threshold (GAT)", desc = "Threshold for gold alert",
            set = function(info, value)
                local oldValue = LA.db.profile.general[info[#info]]
                if oldValue ~= value then
            ...
            args = {
                    ...
                    args = {
                        displayMainUiOptions = { type = "group", order = 10, name = "Main UI", hidden = false, inline = true,
                            args = {
								...
								showDetroyTrashBtn =  { type = "toggle", order = 71, name = "Show 'Destroy Trash' button (/reload required) |cff00ff00NEW!|r", desc = "Show 'Destroy Trash' button |cff00ff00NEW!|r", width = "double", },
								showSellTrashBtn =  { type = "toggle", order = 72, name = "Show 'Sell Trash' button (/reload required) |cff00ff00NEW!|r", desc = "Show 'Sell Trash' button |cff00ff00NEW!|r", width = "double", },
                ...
                aboutGroup = { type = "group", order = 100, name = "About",
                    args = {
                        ...
                        generalText48 = { type = "description", order = 48, fontSize = "medium", name = "ProfitzTV (http://www.youtube.com/ProfitzTV)", width = "double", },
                        blank49 = { type = "description", order = 49, fontSize = "small", name = "", width = "full", },
                        ...
                        generalText100 = { type = "description", order = 100, fontSize = "medium", name = "ACubed10, Brozerian, Conzec89, Goldgoblin, DozerBob, Fatherfajita, GoblinRaset, Hxtasy, JuniorDeBoss\nKillerdamage, Morricade, PhatLewts, Selltacular, Skittlezz420", width = "full", },
                    },
                },
            },
        },
